...
k exec -it $(k get pod -l component=spark-iceberg -o name) -- spark-sql -v

CREATE TABLE default.nyc.taxis
(
  vendor_id bigint,
  trip_id bigint,
  trip_distance float,
...
INSERT INTO default.nyc.taxis
VALUES (1, 1000371, 1.8, 15.32, 'N'), (2, 1000372, 2.5, 22.15, 'N'), (2, 1000373, 0.9, 9.01, 'N'), (1, 1000374, 8.4, 42.13, 'Y');

SELECT * FROM default.nyc.taxis;
```
